...
function concatenateValues(string $firstValue, string $secondValue,
    string $thirdValue, string $fourthValue, string $fifthValue
): string {
...
final class FunctionDeclarationLayout
{
    ...
    public function concatenate(string $firstValue,
        string $secondValue, string $thirdValue, string $fourthValue, string $fifthValue
    ): string {
        return $firstValue . $secondValue . $thirdValue . $fourthValue . $fifthValue;
    }
    ...
    {
        return function (string $firstValue,
            string $secondValue, string $thirdValue, string $fourthValue, string $fifthValue
        ): string
        {
            return $firstValue . $secondValue . $thirdValue . $fourthValue . $fifthValue;
