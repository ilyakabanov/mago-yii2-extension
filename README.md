...
- twelve Yii2 Coding Standards linter rules;
...
The custom rules are `yii2/private-property-underscore`, `yii2/else-if-declaration`, `yii2/short-form-type-keywords`, `yii2/method-scope`, `yii2/constant-visibility`, `yii2/import-statement`, `yii2/class-instantiation`, `yii2/property-declaration`, `yii2/method-declaration`, `yii2/compound-namespace-depth`, `yii2/trait-use-declaration`, and `yii2/class-declaration`.
